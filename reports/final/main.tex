...
\begin{figure}[H]
\centering
\includegraphics[width=0.48\textwidth]{equity_dashboard}
\hfill
\includegraphics[width=0.48\textwidth]{densification_dashboard}
\caption{Dashboard views. Left: Equity Deep Dive showing income quintile accessibility. Right: Densification Alignment showing transit coverage relative to planned growth zones.}
\label{fig:dashboard}
\end{figure}
...
\item Interpretated the coverage/equity figures.
